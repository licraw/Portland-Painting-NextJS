...
<section class="prose prose-lg mx-auto py-12 px-6">
  ...
  <img src="/img/seasonal-maintenance-decks-fences-oregon.png" alt="Wood deck and fence being maintained seasonally in Oregon backyard" class="rounded shadow mb-8 mx-auto max-w-2xl" />
  ...
  <ul class="list-disc list-inside mb-6">
    <li>Use pressure-treated or rot-resistant wood like cedar or redwood.</li>
    <li>Keep the structure ventilated and free from ground contact where possible.</li>
    <li>Re-seal every 1–2 years depending on sun and rain exposure.</li>
    <li>Schedule annual maintenance around Memorial Day and Labor Day weekends.</li>
  </ul>
